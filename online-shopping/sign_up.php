 ...
 <?php
    include('config.php');
        ...
        if(isset($_POST['submit'])){ 
          ...
          $sql="insert into customer values (null,'$name','$address','$city','$zip','$state','$phone','$email','$password')";
      
          $result=$conn->query($sql);
          
          $conn->close();

          header("Location: http://localhost/online-shopping/login.php");
          exit();
    }
   ?>
    ...
    <form action="sign_up.php" method="post">
        ...
        <div class="form-group">
			<div class="row">
                ...
                <div class="col"><input type="int" class="form-control" name="zip" placeholder="Zip" required="required"></div>
                <div class="col"><input type="text" class="form-control" name="state" placeholder="State" required="required"></div>
			</div>        	
        </div>  
        <div class="form-group">
            <input type="int" class="form-control" name="phone" placeholder="phone" required="required">
        </div> 
        <div class="form-group">
